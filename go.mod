...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260906041020-e645a82498ea
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.61.1-0.20260920095503-10fec590cfca
