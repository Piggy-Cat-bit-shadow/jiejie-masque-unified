...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260905003429-b591e8b44496
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.0.0-20260905010856-0f302f5a75d5
