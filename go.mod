...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260920144434-77de33ac2d69
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.61.1-0.20260920144346-bc10ff153606
