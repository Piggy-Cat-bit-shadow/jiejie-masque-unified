...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260920100550-e810d2607e79
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.61.1-0.20260920101551-45a73d788ea1
