...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260905032059-1375f5fae7e5
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.0.0-20260905031927-6674cd87ed84
