...
require (
	github.com/Piggy-Cat-bit-shadow/connect-ip-go v0.0.0-20260905040753-57381910bb5f
...
replace github.com/metacubex/quic-go => github.com/Piggy-Cat-bit-shadow/quic-go v0.0.0-20260905040559-ac11e929d6de
